    ...
    <div class="main-nav-end">
      ...
      <div class="nav-user-wrapper">
        <button class="nav-user-btn dropdown-btn" title="My profile" type="button">
          ...
          <span class="nav-user-img">
            <picture>
              ...
              <img src="/e-service/img/avatar/avatar-illustrated-02.png" alt="User name" />
            </picture>
          </span>
        </button>
        <ul class="users-item-dropdown nav-user-dropdown dropdown">
          ...
          <li><a class="danger" href="/e-service/logout.php"><i data-feather="log-out" aria-hidden="true"></i><span>Log out</span></a></li>
        </ul>
      </div>
    </div>
  </div>
