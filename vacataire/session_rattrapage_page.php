...
// Requête pour la session de rattrapage
    ...
    <style>
        ...
        * {
        ...
        .page-container::before {
            ...
            background: linear-gradient(135deg, var(--warning-color) 0%, #d97706 100%); /* Couleur changée pour différencier */
            z-index: 0;
        }
        ...
        .stat-icon {
            ...
            background: linear-gradient(135deg, var(--warning-color), #b45309); /* Couleur changée */
        ...
        .badge-primary { background-color: #fef3c7; color: #92400e; } /* Couleur changée */
...
<body>
                            ...
                            <div class="stat-value">
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        // Vérifier la bonne colonne pour le rattrapage
                                            ...
                                            <tr id="module-row-<?= $row['id'] ?>">
                                                ...
                                                <td>
                                                    <span class="badge badge-success">
                                                        S<?= htmlspecialchars($row['semestre']) ?>
                                                    </span>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <form onsubmit="return false;" class="file-upload">
                                                        <!-- Envoyer 'rattrapage' comme type de session -->
                                                ...
                                                <td id="actions-cell-<?= $row['id'] ?>">
                                                    <div class="actions-cell">
                                                        <!-- Vérifier et afficher le bon fichier -->
                                                        <?php if (!empty($row['fichier_notes_rattrapage'])): ?>
                                                            <a href="<?= htmlspecialchars($row['fichier_notes_rattrapage']) ?>" target="_blank" class="btn btn-success">
                                                                <i class='bx bx-show'></i>
                                                                Voir
                                                            </a>
                                                            <button class="btn btn-danger" onclick="deleteNotes(<?= $row['id'] ?>, 'rattrapage')">
    ...
    <!-- Le JavaScript est identique et réutilisable -->
    <script>
