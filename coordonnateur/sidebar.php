    ...
    <div class="sidebar-start">
        ...
        <div class="sidebar-body">
            <ul class="sidebar-body-menu">
                ...
                <li>
                    <a href="/e-service/coordonnateur/descriptifpage.php"><span class="icon document" aria-hidden="true"></span>Créer un descriptif </a>
                </li>
                <li>
                ...
                <li>
                  <a href="/e-service/coordonnateur/affectationUEspage.php"> <span class="icon paper" aria-hidden="true"></span>Affectation des UEs</a>
                </li>
                <li>
